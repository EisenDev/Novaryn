...
export default function FloatingHeader({ email, onCopySuccess }: FloatingHeaderProps) {
        ...
        <div className="px-6 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-4">
            <button
              ...
              className="flex items-center gap-1.5 text-sm font-medium text-slate-600 hover:text-slate-900 transition-colors px-3 py-1.5 rounded-lg border border-transparent hover:border-slate-200 bg-transparent hover:bg-slate-50 cursor-pointer"
            >
              {copied ? (
                <>
            ...
            <a
              href={`mailto:${email}`}
              className="bg-emerald-600 hover:bg-emerald-500 text-white font-semibold text-sm px-4.5 py-2.5 rounded-xl transition-all duration-200 shadow-md shadow-emerald-600/10 hover:shadow-emerald-600/20 active:scale-98"
            >
              Book a Consultation
            </a>
          </div>
        ...
        >
          ...
          <div className="flex flex-col gap-3 pt-4 border-t border-slate-100">
            <button
              ...
              className="flex items-center justify-center gap-2 w-full py-3 rounded-xl border border-slate-200 text-sm font-medium text-slate-700 bg-slate-50 hover:bg-slate-100 cursor-pointer"
            >
              {copied ? (
                <>
                  <Check className="w-4 h-4 text-emerald-500" />
            ...
            <a
              href={`mailto:${email}`}
              className="flex items-center justify-center gap-2 w-full py-3 rounded-xl bg-emerald-600 text-sm font-semibold text-white hover:bg-emerald-500 shadow-md shadow-emerald-600/10"
            >
