        ...
        <div className="bg-white border border-slate-200 rounded-3xl overflow-hidden shadow-[0_15px_40px_rgba(15,23,42,0.03)] flex flex-col lg:flex-row items-stretch min-h-[500px]">
          ...
          <div className="flex-1 p-8 sm:p-10 lg:p-12 flex flex-col justify-between text-left">
            ...
            <div className="mt-8 pt-6 border-t border-slate-100 flex flex-wrap gap-3">
              ...
              <a
                href={`mailto:${EMAIL}?subject=Novaryn%20-%20Custom%20Booking%20Platform%20Inquiry`}
                className="flex items-center justify-center gap-2 bg-slate-900 hover:bg-slate-850 text-white font-bold text-xs px-5 py-3 rounded-xl transition-all duration-200 active:scale-98"
              >
